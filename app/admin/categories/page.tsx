...
export default function CategoriesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingCategory) {
        ...
        toast.success(
          "✅ Category updated. Changes will appear on the website within 1 minutes."
        );
        ...
        toast.success(
          "✅ Category created. Changes will appear on the website within 1 minutes."
        );
      }
  ...
  const CategoryRow: React.FC<CategoryRowProps> = ({
    ...
    return (
      <tr
        className={`border-b border-slate-800 text-sm transition-all ${isInactive
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 flex-wrap">
                <p
                  ...
                  className={`font-medium truncate cursor-pointer ${isInactive ? "text-slate-500" : "text-white"
                    }`}
                >
                  {category.name}
                </p>
  ...
  const handleStatusUpdate = async (category: Category) => {
    try {
      ...
      toast.success(
        `Category ${updatedPayload.isActive ? "Activated" : "Deactivated"
        } successfully`
      );
    ...
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
        ...
        <button
          ...
          className={`w-full text-left rounded-lg p-2.5 border transition-all ${statusFilter === "all" &&
            homepageFilter === "all" &&
            levelFilter === "all" &&
            deletedFilter === "all" &&
            searchTerm === ""
        ...
        <button
          ...
          className={`rounded-lg p-2.5 text-left border transition-all ${statusFilter === "active"
        ...
        <button
          ...
          className={`rounded-lg p-2.5 text-left border transition-all ${statusFilter === "inactive"
        ...
        <button
          ...
          className={`rounded-lg p-2.5 text-left border transition-all ${homepageFilter === "yes"
      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-lg px-3 py-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className={`p-2  bg-slate-800/90 border rounded-md text-white text-[11px] ${levelFilter !== "all"
          ...
          <select
            ...
            className={`p-2  bg-slate-800/90 border rounded-md text-white text-[11px] ${deletedFilter !== "all"
          ...
          <select
            ...
            className={`p-2  bg-slate-800/90 border rounded-md text-white text-[11px] ${statusFilter !== "all"
          ...
          <select
            ...
            className={`p-2  bg-slate-800/90 border rounded-md text-white text-[11px] ${homepageFilter !== "all"
                ...
                <div className="flex gap-1">
                  {getPageNumbers().map((pageNum) => (
                    <button
                      ...
                      className={`px-2 py-1 text-[11px] rounded-md transition-all ${currentPage === pageNum
                  ...
                  <div className="bg-gradient-to-br from-violet-500/10 to-cyan-500/10 border border-violet-500/20 rounded-xl p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-slate-900/50 p-3 rounded-lg flex items-center justify-between">
                        ...
                        <span className={`px-2.5 py-1 rounded-lg text-xs font-semibold flex items-center gap-1.5 ${viewingCategory.isActive
                      ...
                      <div className="bg-slate-900/50 p-3 rounded-lg flex items-center justify-between">
                        ...
                        <span className={`px-2.5 py-1 rounded-lg text-xs font-semibold flex items-center gap-1.5 ${viewingCategory.showOnHomepage
      ...
      <ConfirmDialog
        ...
        onConfirm={async () => {
          ...
          try {
            ...
            toast.success(
              `Category ${statusConfirm.isActive ? "deactivated" : "activated"
              } successfully`
            );
        ...
        message={`Are you sure you want to ${statusConfirm?.isActive ? "deactivate" : "activate"
          } "${statusConfirm?.name}"?`}
