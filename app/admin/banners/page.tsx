  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingBanner) {
        ...
        toast.success("Banner updated successfully! changes will be reflect within 5 minutes.");
      } else {
        await bannersService.create(payload);
        toast.success("Banner created successfully! changes will be reflect within 5 minutes.");
      }
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-slate-800/30 p-4 rounded-xl border border-slate-700/50 space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`inline-flex px-3 py-1.5 rounded text-sm font-bold ${viewingBanner.isActive ? 'bg-green-500/10 text-green-400' : 'bg-red-500/10 text-red-400'
                        }`}>
