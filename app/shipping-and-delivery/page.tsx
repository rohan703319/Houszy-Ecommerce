...
export default function ShippingPage() {
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* HERO */}
      <div className="bg-black text-[#f38918] py-2 px-4 text-center">
      ...
      <div className="max-w-8xl mx-auto px-4 py-2 space-y-2 mb-5">
        ...
        <div className="bg-white p-6 rounded-xl border shadow-sm">
          <p className="text-base text-gray-700 leading-relaxed">
            Houszy understands that when you buy a product online, you generally expect it to be delivered to your doorstep as quickly as possible. Please have a look at our shipping and delivery information below and understand how it works.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border shadow-sm">
          ...
          <p className="text-base text-gray-700 mb-3">
            As soon as your order is confirmed and the goods you ordered are shipped from our <strong>Houszy Warehouse</strong>, we will inform you via email. This email will contain the following:
          </p>
          ...
          <p className="text-base text-gray-700 mt-4">
            Please be aware that certain factors beyond our control, such as adverse weather conditions or a surge in demand, may cause delivery delays. Rest assured, our dedicated Customer Service Team will inform you of any changes impacting your order.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border shadow-sm">
          ...
          <p className="text-base text-gray-700 mt-4">
            <strong>Please Note:</strong> Deliveries usually take place from 10 am to 8 pm, and all estimated delivery times are calculated from the moment you place your order, and they do not include weekends and Bank Holidays. A customer’s signature may be required in some cases.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border shadow-sm">
          ...
          <p className="text-base text-gray-700 leading-relaxed">
            Delivery is Monday to Friday, except for bank holidays, and the products on <strong>https://houszy.co.uk/</strong> are delivered all over the UK mainland and Northern Ireland, Isle of Man, Isle of Wight and Scottish Highlands. Please note that the postcodes below do not qualify for next-day delivery:
          </p>

          <div className="text-sm text-gray-700 mt-3 max-h-80 overflow-y-auto leading-relaxed">
