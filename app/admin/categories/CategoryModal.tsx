              ...
              <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700/50 space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg text-sm text-white transition-all ${nameStatus === "duplicate"
                    ...
                    <div className="flex items-center justify-center w-full">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p
                              className={`text-sm ${!formData.name ? "text-slate-600" : "text-slate-400"
                                }`}
                            >
                              {!formData.name ? (
                            ...
                            {formData.name && (
                              <p className="text-xs text-slate-500">Web only (recommended size 914 x 1040 px)</p>
                            )}
                          </div>
                        </div>
                        <input
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <div className={`w-11 h-6 rounded-full ${formData.isActive ? "bg-emerald-500" : "bg-slate-600"
                      }`}>
                ...
                <div>
                  ...
                  >
                    ...
                    <div className={`w-11 h-6 rounded-full ${formData.showOnHomepage ? "bg-cyan-500" : "bg-slate-600"
                      }`}>
