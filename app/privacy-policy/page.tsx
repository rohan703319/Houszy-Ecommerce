    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-8xl mx-auto px-4 py-2 space-y-4 mb-5">
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-1.5">Introduction</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-1.5">Information Collection and Usage</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-1.5">Purpose and Legal Basis</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-1.5">Utilisation of Your Personal Information</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-1.5">Information Recipients</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-1.5">Data Retention</h2>
        ...
        <div className="bg-white p-6 rounded-xlshadow-sm">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-1.5">Restrictions and Portability</h2>
        ...
        <div className="bg-white p-6 rounded-xl">
          <h2 className="text-lg font-semibold mb-1.5">Compliance and Security</h2>
