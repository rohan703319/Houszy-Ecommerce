...
export default function ContactPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10">

        {/* RIGHT — Contact Info + Map (Now displayed on right) */}
        <div className="space-y-5 order-1 lg:order-2">
          ...
          {[
            {
              icon: Phone,
              title: "Contact Us",
              lines: ["+441214616837", "customersupport@houszy.co.uk"],
            ...
            <div key={title} className="bg-white rounded-2xl border border-gray-200 p-5 flex items-start gap-4 shadow-sm hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-xl bg-[#f38918]/10 flex items-center justify-center shrink-0">
                <Icon className="h-5 w-5 text-[#f38918]" />
              </div>
              <div>
          ...
          <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-sm">
            <div className="bg-white px-4 py-2.5 flex items-center gap-2 border-b border-gray-100">
              <MapPin className="h-4 w-4 text-[#f38918]" />
            ...
            <a
              ...
              className="block bg-gray-50 text-center text-xs text-[#f38918] py-2 hover:bg-gray-100 transition-colors"
            >
              View larger map →
            </a>
          </div>
        ...
        {/* LEFT — Form (Now displayed on left) */}
            ...
            {success ? (
              <div className="text-center py-16 px-5">
                ...
                <button
                  ...
                  className="mt-3 px-4 py-1.5 bg-[#f38918] text-white text-xs rounded-md hover:bg-[#3a5237]"
                >
                  Send Message Again
                </button>
              </div>
              ...
              <>
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-2">
                    <MessageSquareMore className="h-6 w-6 text-[#f38918]" />
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Thank you for your interest in Houszy. We are here to assist you and welcome your inquiries.
                  </p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full h-9 px-2.5 pr-7 text-xs border border-gray-300 rounded-md bg-gray-50
                           focus:border-[#f38918] focus:bg-white transition-colors focus:ring-1 focus:ring-[#f38918]/30 outline-none appearance-none"
                      >
                    ...
                    <div className="grid sm:grid-cols-2 gap-1">
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          required
                          className={`w-full h-9 px-2.5 text-xs border rounded-md outline-none bg-gray-50 focus:bg-white transition-colors
...
focus:border-[#f38918]`}
                      ...
                      <div className="space-y-1">
                        ...
                        <div className={`flex items-center border rounded-md overflow-hidden bg-gray-50 focus-within:bg-white transition-colors
    ${fieldErrors.phone ? "border-red-400" : "border-gray-300"}
    focus-within:border-[#f38918]`}>

                          {/* +44 badge */}
                          <div className="px-2 text-xs bg-transparent text-gray-600 font-medium border-r">
                            +44
                          </div>
                          ...
                          <input
                            ...
                            className="w-full h-9 px-2 text-xs outline-none bg-transparent"
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full h-9 px-2.5 text-xs border border-gray-300 rounded-md focus:border-[#f38918] outline-none bg-gray-50 focus:bg-white transition-colors"
                        />
                      </div>
...
focus:border-[#f38918]`}
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        rows={3}
                        required
                        className={`w-full px-2.5 py-2 text-xs border rounded-md resize-none outline-none bg-gray-50 focus:bg-white transition-colors
...
focus:border-[#f38918]`}
    ...
    ${loading
                            ...
                            : "bg-[#f38918] hover:bg-black text-white shadow-md hover:shadow-lg"
                          }`}
                      >
                        {loading ? (
                          <>
          ...
          <div className="mt-5 bg-[#f38918]/5 border border-[#f38918]/20 rounded-2xl p-5 flex items-center justify-between gap-4">
            <div>
            ...
            <Link
              href="/faq"
              className="shrink-0 px-4 py-2 bg-[#f38918] text-white text-sm font-semibold rounded-xl hover:bg-black transition-colors"
            >
              View FAQ
            </Link>
          </div>
